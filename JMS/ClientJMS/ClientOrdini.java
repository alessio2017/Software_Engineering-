...
import javax.jms.*;
import javax.naming.*;
//È asincrono, in particolare è un consumer e bisogna implementare la gestione della logica onMessage().
public class ClientOrdini implements MessageListener{
   ...
   // once we have registerd a message listener with a call to setMessageListener
   // it listens for some events and then call onMessage method as callback in order
   // to implement some filter mechanism
    @Override
